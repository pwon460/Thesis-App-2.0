...
import simo.transport.backend.DatabaseInitializer;
...
public class MainActivity extends BasicListenerActivity {
	...
	public void onDownloadClick(View view) {
		...
		// populate database
		if (initDBFile != null) {
			initializer.initializeDatabase(this, initDBFile);
		}
		if (patchFile != null) {
			initializer.applyPatch(this, patchFile);
		}
		if (weeklyFile != null) {
			initializer.updateException(this, weeklyFile);
		}
	}
